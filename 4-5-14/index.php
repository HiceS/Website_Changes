...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php
            ...
            $menu = array(
                'About Us' => array('index.php?page=About%20Us' => array('About our Robot' => 'index.php?page=About%20Us&sub=2013 Robot','About our Mentors' => 'index.php?page=About%20Us&sub=mentors','About FIRST' => 'index.php?page=About%20Us&sub=first')),
                ...
                'Sponsors' => array('index.php?page=Sponsors' => array('Become a Sponsor' => 'index.php?page=Sponsor%20Us')),
                'Media Gallery' => array('index.php?page=Media%20Gallery' => array('Parts Plans' => 'index.php?page=Parts%20Plans', 'Live Stream' => 'index.php?page=Live%20Stream')),
                'For Parents' => array('index.php?page=For%20Parents' => 'none'),
            );
                ...
                <div>
                    <div id="content">
                        ...
                        <?php
                            ...
                            }elseif ($pagename == "For Parents") {
                            include("content/Parents_content.php");
							...
							}elseif ($pagename == "Live Stream") {
							include("content/livestream.php");
							}
                        ?>		
                    </div>
                    <!-- end content -->
